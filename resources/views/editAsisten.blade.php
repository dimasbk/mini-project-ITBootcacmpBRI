                        ...
                        <form method="POST" action="{{ route('update-asisten', ['id' => $user->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('role') is-invalid @enderror" id="role"
                                    ...
                                    <option value="Asisten" {{ $user->role == 'Asisten' ? 'selected' : '' }}>Asisten
                                    </option>
                                </select>
                                @error('role')
                                    <span class="invalid-feedback">{{ $message }}</span>
